...
<component id="controller">
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-10">
                    <a href="#" v-on:click.prevent="tambahData()" class="btn bn-sm btn-primary pull-right">Tambah Peminjaman</a>
                </div>
                <div class="col-md-2">
                ...
                <div class="modal-content">
                    <form v-bind:action="actionUrl" method="POST" autocomplete="off" v-on:submit="submitForm($event, singleData.id)">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" v-if="editStatus">Ubah Peminjaman</h4>
...
<script>
    let actionUrl = "{{ url('data/detail_peminjaman') }}";
    let columns = [
